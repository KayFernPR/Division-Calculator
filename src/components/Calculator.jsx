          ...
          <div className="space-y-6">
            ...
            <div className="rounded-lg p-6" style={{backgroundColor: '#F9F9F8', borderColor: '#E4E4E3', borderWidth: '1px', borderStyle: 'solid'}}>
              ...
              <div style={{color: '#1F1F1F'}}>
                ...
                <div className="flex items-center gap-2">
                  <img src="/profitable-restorer-emblem.png.png" alt="Profitable Restorer" className="w-6 h-8 flex-shrink-0" style={{verticalAlign: 'middle', display: 'inline-block', marginLeft: '2px'}} />
