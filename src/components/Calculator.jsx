          ...
          {/* Results */}
            ...
            <h2 className="text-2xl font-bold text-neutral-900  mb-4 flex items-center gap-2">
              ...
              <div className="space-y-2">
                ...
                {/* COGS $ */}
                <div className="flex justify-between items-center p-3 border border-red-500 bg-red-50  rounded-lg" style={{borderWidth: '0.5px'}}>
                  <div className="flex items-center gap-2">
                ...
                <div className="flex justify-between items-center p-3 border border-green-500 bg-green-50  rounded-lg" style={{borderWidth: '0.5px'}}>
                  <div className="flex items-center gap-2">
