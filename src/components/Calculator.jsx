          ...
          <div className="space-y-6">
            ...
            <div className="rounded-lg p-6" style={{backgroundColor: '#F9F9F8', borderColor: '#E4E4E3', borderWidth: '1px', borderStyle: 'solid'}}>
              ...
              <div style={{color: '#1F1F1F'}}>
                ...
                <div className="flex items-center gap-2">
                  <img src="/profitable-restorer-emblem.png.png" alt="Profitable Restorer" className="w-6 h-6 flex-shrink-0" style={{verticalAlign: 'middle'}} />
                ...
                <span className="ml-2 text-lg font-semibold">
                  ...
                  {results.profitabilityStatus === 'neutral' && (
                    <span className="flex items-center gap-2">
                      <img src="/profitable-restorer-emblem.png.png" alt="Profitable Restorer" className="w-5 h-5 flex-shrink-0" style={{verticalAlign: 'middle'}} />
